...
#        filter_form = PostFilter(request.GET, queryset=Post.objects.all())
#        news = filter_form.qs
...
#        selected_category = request.GET.get('postCategory')

#        return render(request, 'news_search.html', {'filter_form': filter_form, 'news': news, 'categories': categories, 'selected_category': selected_category})
